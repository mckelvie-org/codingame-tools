...
[![PyPI version](https://img.shields.io/badge/pypi-v2.0.3rc1-blue.svg)](https://test.pypi.org/project/codingame-tools/2.0.3rc1/)
...
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](https://github.com/mckelvie-org/codingame-tools/blob/v2.0.3-rc.1/LICENSE)
...
MIT. See [LICENSE](https://github.com/mckelvie-org/codingame-tools/blob/v2.0.3-rc.1/LICENSE).

---

For development and release workflow, see [CONTRIBUTING.md](https://github.com/mckelvie-org/codingame-tools/blob/v2.0.3-rc.1/CONTRIBUTING.md).
